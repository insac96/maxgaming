...
<template>
  <div>
    <ReceiveStatistic :statistic="statistic" class="mb-4"></ReceiveStatistic>
...
const getList = async () => {
  try {
    ...
    const data = await useAPI($API.Receive.GetOnWorkShift, { ...page.value })
...
const addAction = async () => {
  try {
    ...
    await useAPI($API.Receive.Add, JSON.parse(JSON.stringify(stateAdd.value)))
